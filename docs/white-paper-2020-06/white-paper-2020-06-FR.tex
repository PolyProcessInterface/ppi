...
\begin{titlepage}
	...
	08 Juin 2020 \\[3cm]
	\large{Encadré par Jonathan Lejeune} \hfill \includegraphics[width=5cm]{assets/logoSU.jpg}
\end{titlepage}
		...
		if (infra.getId() == 0) {
			infra.send(new RingMessage(infra.getId(), 1, 0));
				...
				\subsection{Schéma UML des classes génériques}
					\vspace{5mm}
					\hspace*{-1cm} \includegraphics[width=22cm]{assets/generique.png}
...
\end{lstlisting}
						...
						Ainsi, la classe \verb|PeerSiminfrastructure| fait le lien entre notre API générique et l'API de \verb|PeerSim|.
							...
							\hspace*{-1.3cm} \includegraphics[width=17cm]{assets/peersim1.png}
		
							\hspace*{-3.2cm} \includegraphics[width=20cm]{assets/peersim2.png}
	...
	\vspace{10mm}
	\hspace*{-0.7cm} \includegraphics[width=17cm]{assets/diagseq.png}
	\newpage
						\subsubsection{La fonctionnalité de scénario en Peersim}
						\vspace{5mm}
						\hspace*{5cm} \includegraphics[width=60mm]{assets/scenPuml.png}
...
static void add(long delay, java.lang.Object event, Node node, int pid)
		...
		Pour représenter un événement de l'application, nous avons défini donc une interface \verb|AppEvent|,
			...
			Nous avons, cependant, dû ajouter une boucle afin d'adapter le fonctionnement de \verb|MPI| à celui de \verb|PeerSim|.
				...
				\vspace{1mm}
				\hspace*{-2.1cm} \includegraphics[width=19.5cm]{assets/mpi1.png}
				...
				\newpage
				\hspace*{-2.3cm} \includegraphics[width=20cm]{assets/mpi2.png}
				...
				\vspace{5mm}
				\hspace*{4cm} \includegraphics[width=80mm]{assets/scenMPIuml.png}
