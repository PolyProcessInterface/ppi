...
\end{titlepage}
	...
	\newpage
		...
		\section{Introduction et motivations}
			...
			\subsection{Exemple d'un anneau en MPI}
...
public class RingMpi {
	...
	public static void main(String[] args) {
			...
			MPI.Finalize();
                ...
                \end{lstlisting}
			\subsection{Exemple d'un anneau en Peersim}
...
public class ExampleNodeProcess extends NodeProcess {
	...
	public void init(String[] args) {
		...
		\section{Méthode de développement d'applications réparties existantes}
			...
			\subsection{API simulation à évenements discrets}
		...
		%TODO
		\section{Implémentation de la fonctionnalité de scénario}
