...
var Ea={},Da={};var Fa=/&/g,Ga=/</g,Ha=/>/g,Ia=/"/g,Ja=/'/g,Ka=/\x00/g,La=/[\x00&<>"']/;var I;a:{var Ma=r.navigator;if(Ma){var Na=Ma.userAgent;if(Na){I=Na;break a}}I=""};function J(){this.a="";this.b=Oa}
var Oa={};function Pa(a){var b=new J;b.a=a;return b}
Pa("<!DOCTYPE html>");var K=Pa("");Pa("<br>");function Qa(a){var b=new H(Da,G instanceof F&&G.constructor===F&&G.a===Ca?G.b:"type_error:Const");a.src=(b instanceof H&&b.constructor===H&&b.a===Ea?b.b:"type_error:TrustedResourceUrl").toString()}
...
var ib;
function jb(){var a=r.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&-1==I.indexOf("Presto")&&(a=function(){var e=Sa();e.style.display="none";Qa(e);document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(K instanceof J&&K.constructor===J&&K.b===Oa?K.a:"type_error:SafeHtml");e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=
...
!(c="function"!=w(r.setImmediate))&&(c=r.Window&&r.Window.prototype)&&(c=-1==I.indexOf("Edge")&&r.Window.prototype.setImmediate==r.setImmediate);c?(ib||(ib=jb()),ib(b)):r.setImmediate(b)}}
